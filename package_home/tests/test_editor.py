...
base_path = r"C:\VSCode\Python\Voice\Data\Recorded\Batuhan"
text_wav = os.path.join(base_path, "Batuhan_0.wav")
voice_wav = os.path.join(base_path, "Batuhan_1.wav")

# İşlem yapacak fonksiyon
def test_process_audio(input_wav, output_no_silence_wav, chunks_output_dir):
...
test_process_audio(voice_wav, os.path.join(base_path, "Batuhan_0.wav"), chunks_output_dir)
test_process_audio(text_wav, os.path.join(base_path, "Batuhan_1.wav"), chunks_output_dir)
